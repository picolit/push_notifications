...
function onPushSubscription(e) {
    ...
    i.addEventListener("click", function() {
        var e = new FormData;
        e.append("subscriptionId", t), e.append("endpoint", s), fetch(PUSH_SERVER_URL + "/send_push", {method: "post",body: e}).then(function(e) {
            console.log("Response = ", e)
        })["catch"](function(e) {
            console.log("Fetch Error :-S", e)
        })
    });
    var n = 'curl --header "Authorization: key=' + API_KEY + '" --header Content-Type:"application/json" ' + s + ' -d "{\\"registration_ids\\":[\\"' + t + '\\"]}"', a = document.querySelector(".js-curl-code");
    a.innerHTML = n
}
...
function MaterialTab(e, s) {
    if (e) {
        ...
        e.addEventListener("click", function(t) {
            t.preventDefault();
            var i = e.href.split("#")[1], n = document.querySelector("#" + i);
...
function MaterialLayoutTab(e, s, t, i) {
    if (e) {
        ...
        e.addEventListener("click", function(n) {
            n.preventDefault();
            var a = e.href.split("#")[1], o = i.content_.querySelector("#" + a);
...
var componentHandler = function() {
    ...
    function i(s) {
        var t = {classConstructor: s.constructor,className: s.classAsString,cssClass: s.cssClass,callbacks: []}, i = e(s.classAsString, t);
        i || o.push(t)
    }
    function n(s, t) {
        var i = e(s);
    ...
    var o = [], r = [];
    return {upgradeDom: s,upgradeElement: t,upgradeAllRegistered: a,registerUpgradedCallback: n,register: i}
}();
window.addEventListener("load", function() {
...
}(), MaterialAnimation.prototype.Constant_ = {STARTING_POSITION: 1}, MaterialAnimation.prototype.CssClasses_ = {DEMO_JS_MOVABLE_AREA: "demo-js-movable-area",DEMO_POSITION_PREFIX: "demo-position-"}, MaterialAnimation.prototype.handleClick_ = function() {
...
}, componentHandler.register({constructor: MaterialCheckbox,classAsString: "MaterialCheckbox",cssClass: "wsk-js-checkbox"}), MaterialColumnLayout.prototype.Constant_ = {INVISIBLE_WRAPPING_ELEMENT_COUNT: 3}, MaterialColumnLayout.prototype.CssClasses_ = {INVISIBLE_WRAPPING_ELEMENT: "wsk-column-layout__wrap-hack"}, MaterialColumnLayout.prototype.init = function() {
    if (this.element_)
...
}, componentHandler.register({constructor: MaterialIconToggle,classAsString: "MaterialIconToggle",cssClass: "wsk-js-icon-toggle"}), MaterialItem.prototype.Constant_ = {}, MaterialItem.prototype.CssClasses_ = {WSK_ITEM_RIPPLE_CONTAINER: "wsk-item--ripple-container",WSK_RIPPLE: "wsk-ripple"}, MaterialItem.prototype.init = function() {
    if (this.element_) {
        var e = document.createElement("span");
...
}, componentHandler.register({constructor: MaterialTabs,classAsString: "MaterialTabs",cssClass: "wsk-js-tabs"}), MaterialTextfield.prototype.Constant_ = {NO_MAX_ROWS: -1,MAX_ROWS_ATTRIBUTE: "maxrows"}, MaterialTextfield.prototype.CssClasses_ = {WSK_TEXT_EXP_ICO_RIP_CONTAINER: "wsk-textfield-expandable-icon__ripple__container",WSK_JS_RIPPLE_EFFECT: "wsk-js-ripple-effect",WSK_RIPPLE_CENTER: "wsk-ripple--center",WSK_RIPPLE: "wsk-ripple",IS_DIRTY: "is-dirty"}, MaterialTextfield.prototype.expandableIcon_ = function(e) {
...
}, componentHandler.register({constructor: MaterialTextfield,classAsString: "MaterialTextfield",cssClass: "wsk-js-textfield"}), MaterialTooltip.prototype.Constant_ = {}, MaterialTooltip.prototype.CssClasses_ = {IS_ACTIVE: "is-active"}, MaterialTooltip.prototype.handleMouseEnter_ = function(e) {
    e.stopPropagation();
    ...
    if (this.element_) {
        var e = this.element_.getAttribute("for"), s = document.getElementById(e);
...
}, componentHandler.register({constructor: MaterialLayout,classAsString: "MaterialLayout",cssClass: "wsk-js-layout"}), MaterialRipple.prototype.Constant_ = {INITIAL_SCALE: "scale(0.0001, 0.0001)",INITIAL_SIZE: "1px",INITIAL_OPACITY: "0.4",FINAL_OPACITY: "0",FINAL_SCALE: ""}, MaterialRipple.prototype.CssClasses_ = {WSK_RIPPLE_CENTER: "wsk-ripple--center",WSK_JS_RIPPLE_EFFECT_IGNORE_EVENTS: "wsk-js-ripple-effect--ignore-events",WSK_RIPPLE: "wsk-ripple",IS_ANIMATING: "is-animating"}, MaterialRipple.prototype.downHandler_ = function(e) {
    if ("mousedown" === e.type && this.ignoringMouseDown_)
        ...
        if (0 === e.clientX && 0 === e.clientY)
            t = Math.round(n.width / 2), i = Math.round(n.height / 2);
        else {
            var a = e.clientX ? e.clientX : e.touches[0].clientX, o = e.clientY ? e.clientY : e.touches[0].clientY;
...
}, "undefined" != typeof componentHandler && componentHandler.register({constructor: MaterialRipple,classAsString: "MaterialRipple",cssClass: "wsk-js-ripple-effect"});
